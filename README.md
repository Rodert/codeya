 ...
 * @LastEditTime: 2025-03-12 12:08:58
...
### 2025-03-12
- 添加分类排序功能，通过order字段控制首页分类列表的显示顺序
- 优化README文档，完善项目说明和结构
- 更新分类数据，确保所有分类都有正确的order值
- 添加详细更新日志记录系统

### 2025-03-11
- 更新README.md，添加更多项目说明
- 优化categories.js中的分类描述，使其更加专业和详细
- 修复首页分类展示顺序问题
